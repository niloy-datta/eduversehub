...
export default function PostgresqlCoursePage() {
  const modules: Module[] = [
    {
      ...
      duration: '45 min',
      lessons: [
        { id: '1-1', title: 'Introduction', type: 'article', duration: '15 min', completed: false, locked: false, href: '/lessons/postgresql/intro' },
        { id: '1-2', title: 'Advanced Data Types', type: 'article', duration: '30 min', completed: false, locked: false, href: '/lessons/postgresql/types' },
      ]
    },
    {
      id: 2,
      ...
      duration: '1h',
      lessons: [
        { id: '2-1', title: 'Window Functions', type: 'code', duration: '30 min', completed: false, locked: false, href: '/lessons/postgresql/window-functions' },
        { id: '2-2', title: 'Performance & Indexing', type: 'code', duration: '30 min', completed: false, locked: false, href: '/lessons/postgresql/performance' },
      ]
    }
  ];
      ...
      <main className="container-custom py-12">
        <div className="mb-12 animate-fade-in-up">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="w-full md:w-1/3 aspect-video bg-linear-to-br from-indigo-500 to-blue-700 rounded-2xl flex items-center justify-center shadow-lg shadow-indigo-500/20 border border-indigo-500/30">
            ...
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-400 text-sm font-medium mb-4">
                ...
                The World&apos;s Most Advanced DB
              </div>
              <h1 className="text-4xl md:text-5xl font-display font-bold text-white mb-4">
                Mastering <span className="gradient-text from-indigo-400 to-blue-600">PostgreSQL</span>
              </h1>
              <p className="text-dark-300 text-lg mb-6 leading-relaxed">
                Unlock the power of PostgreSQL. Learn advanced data types, window functions, and performance optimization for enterprise apps.
              </p>
              ...
              <div className="flex gap-4">
                <Link href="/lessons/postgresql/intro" className="btn-primary px-8 py-3 rounded-xl shadow-lg shadow-primary-500/20 hover:shadow-primary-500/40 transition-all text-center flex-1 md:flex-none">
                  Start Learning
                </Link>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <div className="card-glass p-6 sticky top-24">
              ...
              <p className="text-sm text-dark-400 mb-6">1/15 Lessons Completed (10%)</p>
            </div>
          </div>
        </div>
      </main>
