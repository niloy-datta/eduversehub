  ...
  const modules: Module[] = [
    {
      ...
      duration: '1h',
      lessons: [
        { id: '1-1', title: 'Introduction', type: 'article', duration: '15 min', completed: false, locked: false, href: '/lessons/react/intro' },
        { id: '1-2', title: 'Components', type: 'article', duration: '20 min', completed: false, locked: false, href: '/lessons/react/components' },
        { id: '1-3', title: 'Props', type: 'article', duration: '25 min', completed: false, locked: false, href: '/lessons/react/props' },
      ]
    },
    {
      id: 2,
      ...
      duration: '1h 30m',
      lessons: [
        { id: '2-1', title: 'State & useState', type: 'code', duration: '30 min', completed: false, locked: false, href: '/lessons/react/state' },
        { id: '2-2', title: 'Conditional Rendering', type: 'article', duration: '30 min', completed: false, locked: false, href: '/lessons/react/conditional-rendering' },
        { id: '2-3', title: 'The useEffect Hook', type: 'code', duration: '30 min', completed: false, locked: false, href: '/lessons/react/useEffect' },
      ]
    },
    {
      id: 3,
      ...
      duration: '1h',
      lessons: [
        { id: '3-1', title: 'Context API', type: 'code', duration: '30 min', completed: false, locked: false, href: '/lessons/react/context' },
        { id: '3-2', title: 'React Routing', type: 'guide', duration: '30 min', completed: false, locked: false, href: '/lessons/react/routing' },
      ]
    }
  ];
      ...
      <main className="container-custom py-12">
        <div className="mb-12 animate-fade-in-up">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="w-full md:w-1/3 aspect-video bg-linear-to-br from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg shadow-cyan-500/20 border border-cyan-500/30">
            ...
            <div className="flex-1">
              ...
              <h1 className="text-4xl md:text-5xl font-display font-bold text-white mb-4">
                Mastering <span className="gradient-text from-cyan-400 to-blue-600">React</span>
              </h1>
              <p className="text-dark-300 text-lg mb-6 leading-relaxed">
                Build fast, modern, and interactive web applications with the world&apos;s most popular UI library.
              </p>
              ...
              <div className="flex gap-4">
                <Link href="/lessons/react/intro" className="btn-primary px-8 py-3 rounded-xl shadow-lg shadow-primary-500/20 hover:shadow-primary-500/40 transition-all text-center flex-1 md:flex-none">
                  Start Learning
                </Link>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <div className="card-glass p-6 sticky top-24">
              ...
              <p className="text-sm text-dark-400 mb-6">1/30 Lessons Completed (3%)</p>
            </div>
          </div>
        </div>
      </main>
