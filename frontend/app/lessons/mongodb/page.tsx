...
export default function MongodbCoursePage() {
  const modules: Module[] = [
    {
      ...
      duration: '35 min',
      lessons: [
        { id: '1-1', title: 'Introduction', type: 'article', duration: '15 min', completed: false, locked: false, href: '/lessons/mongodb/intro' },
        { id: '1-2', title: 'CRUD Operations', type: 'code', duration: '20 min', completed: false, locked: false, href: '/lessons/mongodb/crud' },
      ]
    },
    {
      id: 2,
      ...
      duration: '30 min',
      lessons: [
        { id: '2-1', title: 'Schema Design', type: 'article', duration: '30 min', completed: false, locked: false, href: '/lessons/mongodb/schema-design' },
      ]
    },
    {
      id: 3,
      ...
      duration: '1h',
      lessons: [
        { id: '3-1', title: 'Aggregation', type: 'code', duration: '30 min', completed: false, locked: false, href: '/lessons/mongodb/aggregation' },
        { id: '3-2', title: 'Indexing', type: 'article', duration: '30 min', completed: false, locked: false, href: '/lessons/mongodb/indexing' },
      ]
    }
  ];
      ...
      <main className="container-custom py-12">
        <div className="mb-12 animate-fade-in-up">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="w-full md:w-1/3 aspect-video bg-linear-to-br from-green-500 to-emerald-700 rounded-2xl flex items-center justify-center shadow-lg shadow-green-500/20 border border-green-500/30">
            ...
            <div className="flex-1">
              ...
              <h1 className="text-4xl md:text-5xl font-display font-bold text-white mb-4">
                Mastering <span className="gradient-text from-green-400 to-emerald-600">MongoDB</span>
              </h1>
              <p className="text-dark-300 text-lg mb-6 leading-relaxed">
                Learn the most popular document database. Master CRUD, Aggregation, and Schema Design for modern scalable apps.
              </p>
              ...
              <div className="flex gap-4">
                <Link href="/lessons/mongodb/intro" className="btn-primary px-8 py-3 rounded-xl shadow-lg shadow-primary-500/20 hover:shadow-primary-500/40 transition-all text-center flex-1 md:flex-none">
                  Start Learning
                </Link>
          ...
          <div className="space-y-6">
            <div className="card-glass p-6 sticky top-24">
              ...
              <div className="w-full h-3 bg-dark-800 rounded-full overflow-hidden mb-2">
                <div className="h-full bg-success-500 w-[8%]"></div>
              </div>
              <p className="text-sm text-dark-400 mb-6">1/18 Lessons Completed (8%)</p>
            </div>
          </div>
        </div>
      </main>
